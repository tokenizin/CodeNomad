...
export const COMMAND_REGISTRY: CommandEntry[] = [
  ...
  // ── Understand-Anything Commands ──
  {
    name: "understand",
    aliases: ["ua", "analyze-codebase"],
    category: "skill",
    description: "Analyze a codebase into a knowledge graph using Understand-Anything",
    usage: "/understand [project-path]",
    examples: ["/understand", "/understand /Users/alexshapiro/starworld"],
    requiresConfirmation: false,
  },
  {
    name: "understand-dashboard",
    aliases: ["ua-dashboard", "ua-view"],
    category: "skill",
    description: "Launch the interactive knowledge-graph dashboard",
    usage: "/understand-dashboard [project-path]",
    examples: ["/understand-dashboard", "/understand-dashboard /Users/alexshapiro/starworld"],
    requiresConfirmation: false,
  },
  {
    name: "understand-chat",
    aliases: ["ua-chat", "ua-ask"],
    category: "skill",
    description: "Ask questions about the codebase using the knowledge graph",
    usage: "/understand-chat <question>",
    examples: ["/understand-chat How does auth work?", "/understand-chat What are the main domains?"],
    requiresConfirmation: false,
  },
  {
    name: "understand-domain",
    aliases: ["ua-domain", "extract-domains"],
    category: "skill",
    description: "Extract business domain knowledge and generate a domain flow graph",
    usage: "/understand-domain [--full]",
    examples: ["/understand-domain", "/understand-domain --full"],
    requiresConfirmation: false,
  },
  {
    name: "understand-explain",
    aliases: ["ua-explain", "ua-file"],
    category: "skill",
    description: "Deep-dive into a specific file or function",
    usage: "/understand-explain <file-path>",
    examples: ["/understand-explain src/auth.ts", "/understand-explain packages/server/src/index.ts"],
    requiresConfirmation: false,
  },
  {
    name: "understand-diff",
    aliases: ["ua-diff", "ua-impact"],
    category: "skill",
    description: "Analyze the impact of changes using the knowledge graph",
    usage: "/understand-diff [commit-range]",
    examples: ["/understand-diff", "/understand-diff HEAD~3..HEAD"],
    requiresConfirmation: false,
  },
  {
    name: "understand-knowledge",
    aliases: ["ua-knowledge", "ua-kb"],
    category: "skill",
    description: "Analyze and merge knowledge bases",
    usage: "/understand-knowledge <action>",
    examples: ["/understand-knowledge status", "/understand-knowledge merge"],
    requiresConfirmation: false,
  },
  {
    name: "understand-onboard",
    aliases: ["ua-onboard", "ua-start"],
    category: "skill",
    description: "Generate an onboarding guide from the knowledge graph",
    usage: "/understand-onboard",
    examples: ["/understand-onboard"],
    requiresConfirmation: false,
  },
  {
    name: "understand-figma",
    aliases: ["ua-figma", "ua-design"],
    category: "skill",
    description: "Integrate Figma design files into the knowledge graph",
    usage: "/understand-figma <figma-url>",
    examples: ["/understand-figma https://figma.com/file/abc123"],
    requiresConfirmation: false,
  },
