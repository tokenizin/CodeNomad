export const settingsMessages = {
  ...
  "notifyHistory.title": "Categorized History",
  "notifyHistory.empty": "No categorized notifications yet",
  "notifyHistory.empty.filter": "No matching notifications for this filter",
  "notifyHistory.clearAll": "Clear all",
  "notifyHistory.markAllRead": "Mark all read",
  "notifyHistory.close": "Close",
  "notifyHistory.today": "Today",
  "notifyHistory.yesterday": "Yesterday",
  "notifyHistory.earlier": "Earlier",
  "notifyHistory.unread": "{count} unread",
  "notifyHistory.filter.all": "All",
  "notifyHistory.filter.category": "Category",
  "notifyHistory.acknowledge": "Acknowledge",
  "notifyHistory.dismiss": "Dismiss",
  "notifyHistory.details": "Details",
  "notifyHistory.escalation": "Escalation",
  "notifyHistory.mitigate": "Mitigation",
  "notifyHistory.workaround": "Workaround",
  "notifyHistory.helpRequired": "Help Required",
  "notifyHistory.successProgress": "Progress",
  "notifyHistory.actions": "Actions",
