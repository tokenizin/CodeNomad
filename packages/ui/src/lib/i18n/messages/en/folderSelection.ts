export const folderSelectionMessages = {
  ...
  "folderSelection.newRepo.button": "New Git Repo",
  "folderSelection.newRepo.dialog.title": "Initialize New Git Repository",
  "folderSelection.newRepo.dialog.description": "Create a new local Git repository and open it as your workspace.",
  "folderSelection.newRepo.dialog.destinationPath": "Repository folder",
  "folderSelection.newRepo.dialog.destinationPathPlaceholder": "Select or enter a destination folder",
  "folderSelection.newRepo.dialog.browseDestination": "Browse",
  "folderSelection.newRepo.dialog.initialCommit": "Create an initial commit with a README",
  "folderSelection.newRepo.dialog.readmePlaceholder": "README content",
  "folderSelection.newRepo.dialog.bare": "Create as bare repository",
  "folderSelection.newRepo.dialog.cancel": "Cancel",
  "folderSelection.newRepo.dialog.create": "Create Repo",
  "folderSelection.newRepo.dialog.creating": "Initializing...",
  "folderSelection.newRepo.dialog.errorRequired": "Destination folder is required.",
