export const messagingMessages = {
  ...
  "promptInput.placeholder.shell": "Run a bash command in the open folder (Esc to chat)...",
  "promptInput.placeholder.default": "Type your message, @file, @agent, or paste images and text...",
  "promptInput.modeToggle.ariaLabel": "Composer mode",
  "promptInput.modeToggle.chat": "Chat",
  "promptInput.modeToggle.cli": "CLI",
  "promptInput.cli.cwdLabel": "cwd",
  "promptInput.cli.empty": "Commands run in the open workspace folder. Output appears here.",
  "promptInput.cli.running": "Running…",
  "promptInput.cli.timedOut": "Timed out after 60s",
  "promptInput.cli.exitCode": "exit {code}",
  "promptInput.cli.runAriaLabel": "Run command",
  "promptInput.cli.errorTitle": "Command failed",
  "promptInput.cli.errorFallback": "Unable to run command in the open folder",
