export const messagingMessages = {
  ...
  "messageBlock.reasoning.thoughtFor.seconds.one": "חשב במשך שנייה אחת",
  "messageBlock.reasoning.thoughtFor.seconds.other": "חשב במשך {count} שניות",
  "messageBlock.reasoning.thoughtFor.minutes.one": "חשב במשך דקה אחת",
  "messageBlock.reasoning.thoughtFor.minutes.other": "חשב במשך {count} דקות",
  "messageBlock.reasoning.thoughtFor.hours.one": "חשב במשך שעה אחת",
