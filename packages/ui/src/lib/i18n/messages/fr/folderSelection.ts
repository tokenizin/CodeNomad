export const folderSelectionMessages = {
  ...
  "folderSelection.newRepo.button": "Nouveau depot Git",
  "folderSelection.newRepo.dialog.title": "Initialiser un nouveau depot Git",
  "folderSelection.newRepo.dialog.description": "Creez un nouveau depot Git local et ouvrez-le comme espace de travail.",
  "folderSelection.newRepo.dialog.destinationPath": "Dossier du depot",
  "folderSelection.newRepo.dialog.destinationPathPlaceholder": "Selectionnez ou saisissez un dossier de destination",
  "folderSelection.newRepo.dialog.browseDestination": "Parcourir",
  "folderSelection.newRepo.dialog.initialCommit": "Creez un commit initial avec un README",
  "folderSelection.newRepo.dialog.readmePlaceholder": "Contenu du README",
  "folderSelection.newRepo.dialog.bare": "Creez comme depot bare",
  "folderSelection.newRepo.dialog.cancel": "Annuler",
  "folderSelection.newRepo.dialog.create": "Creer le depot",
  "folderSelection.newRepo.dialog.creating": "Initialisation...",
  "folderSelection.newRepo.dialog.errorRequired": "Le dossier de destination est requis.",
