export const folderSelectionMessages = {
  ...
  "folderSelection.newRepo.button": "Nuevo repo Git",
  "folderSelection.newRepo.dialog.title": "Inicializar nuevo repositorio Git",
  "folderSelection.newRepo.dialog.description": "Crea un nuevo repositorio Git local y ábrelo como tu espacio de trabajo.",
  "folderSelection.newRepo.dialog.destinationPath": "Carpeta del repositorio",
  "folderSelection.newRepo.dialog.destinationPathPlaceholder": "Selecciona o introduce una carpeta de destino",
  "folderSelection.newRepo.dialog.browseDestination": "Buscar",
  "folderSelection.newRepo.dialog.initialCommit": "Crear commit inicial con un README",
  "folderSelection.newRepo.dialog.readmePlaceholder": "Contenido del README",
  "folderSelection.newRepo.dialog.bare": "Crear como repositorio bare",
  "folderSelection.newRepo.dialog.cancel": "Cancelar",
  "folderSelection.newRepo.dialog.create": "Crear repo",
  "folderSelection.newRepo.dialog.creating": "Inicializando...",
  "folderSelection.newRepo.dialog.errorRequired": "La carpeta de destino es obligatoria.",
