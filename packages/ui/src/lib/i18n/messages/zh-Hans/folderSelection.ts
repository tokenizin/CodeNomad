export const folderSelectionMessages = {
  ...
  "folderSelection.newRepo.button": "新建 Git 仓库",
  "folderSelection.newRepo.dialog.title": "初始化新的 Git 仓库",
  "folderSelection.newRepo.dialog.description": "创建一个新的本地 Git 仓库并将其作为工作区打开。",
  "folderSelection.newRepo.dialog.destinationPath": "仓库文件夹",
  "folderSelection.newRepo.dialog.destinationPathPlaceholder": "选择或输入目标文件夹",
  "folderSelection.newRepo.dialog.browseDestination": "浏览",
  "folderSelection.newRepo.dialog.initialCommit": "创建包含 README 的初始提交",
  "folderSelection.newRepo.dialog.readmePlaceholder": "README 内容",
  "folderSelection.newRepo.dialog.bare": "创建为裸仓库",
  "folderSelection.newRepo.dialog.cancel": "取消",
  "folderSelection.newRepo.dialog.create": "创建仓库",
  "folderSelection.newRepo.dialog.creating": "正在初始化...",
  "folderSelection.newRepo.dialog.errorRequired": "目标文件夹为必填项。",
