export const instanceMessages = {
  ...
  "instanceShell.filesShell.imagePreview.toggle": "图片预览",
  "instanceShell.filesShell.imagePreview.tooLarge": "图片过大无法预览 (> 10 MB) — 在外部应用中打开",
  "instanceShell.filesShell.imagePreview.openExternally": "在外部应用中打开",
