export const folderSelectionMessages = {
  ...
  "folderSelection.newRepo.button": "新しい Git リポジトリ",
  "folderSelection.newRepo.dialog.title": "新しい Git リポジトリを初期化",
  "folderSelection.newRepo.dialog.description": "新しいローカル Git リポジトリを作成し、ワークスペースとして開きます。",
  "folderSelection.newRepo.dialog.destinationPath": "リポジトリフォルダ",
  "folderSelection.newRepo.dialog.destinationPathPlaceholder": "保存先フォルダを選択または入力",
  "folderSelection.newRepo.dialog.browseDestination": "参照",
  "folderSelection.newRepo.dialog.initialCommit": "README を含む初期コミットを作成",
  "folderSelection.newRepo.dialog.readmePlaceholder": "README 内容",
  "folderSelection.newRepo.dialog.bare": "ベアリポジトリとして作成",
  "folderSelection.newRepo.dialog.cancel": "キャンセル",
  "folderSelection.newRepo.dialog.create": "リポジトリを作成",
  "folderSelection.newRepo.dialog.creating": "初期化中...",
  "folderSelection.newRepo.dialog.errorRequired": "保存先フォルダは必須です。",
