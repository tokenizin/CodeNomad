export const folderSelectionMessages = {
  ...
  "folderSelection.newRepo.button": "Новый Git-репозиторий",
  "folderSelection.newRepo.dialog.title": "Инициализировать новый Git-репозиторий",
  "folderSelection.newRepo.dialog.description": "Создайте новый локальный Git-репозиторий и откройте его как рабочую область.",
  "folderSelection.newRepo.dialog.destinationPath": "Папка репозитория",
  "folderSelection.newRepo.dialog.destinationPathPlaceholder": "Выберите или введите папку назначения",
  "folderSelection.newRepo.dialog.browseDestination": "Обзор",
  "folderSelection.newRepo.dialog.initialCommit": "Создать начальный коммит с README",
  "folderSelection.newRepo.dialog.readmePlaceholder": "Содержимое README",
  "folderSelection.newRepo.dialog.bare": "Создать как bare-репозиторий",
  "folderSelection.newRepo.dialog.cancel": "Отмена",
  "folderSelection.newRepo.dialog.create": "Создать репозиторий",
  "folderSelection.newRepo.dialog.creating": "Инициализация...",
  "folderSelection.newRepo.dialog.errorRequired": "Папка назначения обязательна.",
