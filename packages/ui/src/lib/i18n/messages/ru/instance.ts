export const instanceMessages = {
  ...
  "instanceShell.filesShell.imagePreview.toggle": "Предпросмотр изображения",
  "instanceShell.filesShell.imagePreview.tooLarge": "Изображение слишком большое для предпросмотра (> 10 МБ) — открыть во внешнем приложении",
  "instanceShell.filesShell.imagePreview.openExternally": "Открыть во внешнем приложении",
